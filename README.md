# IC-LabWork
Repository holding the code, data and plots made for the analysis of data collected in 540 lab (2025-2026) for WCTE including optical power meter, monitor PMT and laser diffuser
